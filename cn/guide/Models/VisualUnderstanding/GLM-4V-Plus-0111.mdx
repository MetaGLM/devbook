...
<AccordionGroup>
    <Accordion title="视频理解" titleSize="h3">
        ### 上传视频URL
    ...
    <Accordion title="图片理解" titleSize="h3">
        ### 上传图片URL
